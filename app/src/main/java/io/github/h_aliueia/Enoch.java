...
public class Enoch extends Fragment
{
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_enoch, container, false);
        backpress(rootView);
        fab();
        return rootView;
    }
    ...
    public void backpress(View rootView)
    {
        ...
        rootView.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                ...
                {
                    ((MainActivity)getActivity()).fragmentreplacerfromfrag(3);
                    return true;
                }
                else
                {
