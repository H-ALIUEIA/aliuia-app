...
public class Unlearn2 extends Fragment
{
    ...
    {
        View rootview = inflater.inflate(R.layout.fragment_unlearn2, container, false);
        backpress(rootview);
        fab();
        return rootview;
    }
    ...
    public void backpress(View rootView)
    {
        ...
        rootView.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                ...
                {
                    ((MainActivity)getActivity()).fragmentreplacerfromfrag(2);
                    return true;
                }
                else
                {
