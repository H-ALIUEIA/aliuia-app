...
public class tutorial extends AppIntro
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        addSlide(AppIntroFragment.createInstance(
            "Αποσπάσματα",
            "Στο Μενού αποσπάσματα\n" +
                "Μπορείτε να πατήσετε το κουμπί πυγή πάνω δεξιά\n" +
                "Για να δείτε την πυγή αυτού του αποσπάσματος\n" +
        ...
        addSlide(AppIntroFragment.createInstance(
            "Shorts (Μικρά Βίντεο)",
            "Στο Μενού των Shorts (Μικρά Βίντεο)\n" +
                "Μπορείτε να πατήσετε κουμπί πυγή στα δεξιά\n" +
                "Για να αντιγράψετε την πυγή αυτού του βίντεο",
            R.drawable.tut7,
            R.color.part1
        ));
        addSlide(AppIntroFragment.createInstance(
